...
; clj -X:build:prod:hello-fiddle build-client :hyperfiddle.fiddle-build/fiddle-ns hello-fiddle :debug true
; clj -X:build:prod:hello-fiddle uberjar :hyperfiddle.fiddle-build/fiddle-ns hello-fiddle :hyperfiddle.fiddle-build/deps-alias :hello-fiddle :debug true
